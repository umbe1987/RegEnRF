...
This is an example showsing how to perform Regression-Enhanced Random Forests regression with `rerf`. It demonstrates how `rerf` can extrapolate beyond the the training domain, as opposed to `randomForest`.
